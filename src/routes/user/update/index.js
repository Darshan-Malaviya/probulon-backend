...
exports.rule = Joi.object({
	...
	deviceId: Joi.string().optional().allow('').min(24).max(24).example('John').description('DeviceId of User'),
	...
	userType: Joi.number().optional().valid(1,2,3).example(1).description('UserType: 1 - client, 2 - user, 3 - admin'),
	...
	documentType: Joi.number().optional().valid(1,2,3).example(1).description('documentType: 1 - NIF (Tax ID Number), 2 - NIE (Foreigner Identification Number), 3 - CIF (Corporate Tax ID)'),
