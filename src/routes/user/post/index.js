	...
	try {
		...
		if(req.body.userType === 1) {
			...
			const deviceData = {
				...
				name: req.body.name ? req.body.name : '',
				status: req.body.deviceStatus ? req.body.deviceStatus : 0,
				statusText: deviceMap[req.body.deviceStatus] || 'Off',
				...
				postalCode: req.body.postalCode ? req.body.postalCode : '',
				country: req.body.country ? req.body.country : '',
				town: req.body.town ? req.body.ctownountry : '',
